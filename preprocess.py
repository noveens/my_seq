...
def remove_rare_elements(data, min_user_activity, min_item_popularity):
	...
	print(min_user_activity, min_item_popularity)
...
def split_data(train_data, test_data, dirname):
	...
	print(nb_users, nb_val_users, nb_test_users)
	...
	val_set = train_data[int(len(train_data) * 0.7):]
...
def main():
	...
	train_data = load_data('/home/thealchemist/datasets/new_data/train_updated.csv', args.columns, args.sep)
	test_data = load_data('/home/thealchemist/datasets/new_data/test_updated.csv', args.columns, args.sep)
	...
	train_set, val_set, test_set = split_data(train_data, test_data, args.dirname)
	print('len training = ', len(train_set), 'len testing = ', len(test_set))
